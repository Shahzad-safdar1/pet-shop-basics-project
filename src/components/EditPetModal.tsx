...
const EditPetModal: React.FC<EditPetModalProps> = ({ isOpen, onClose, onEdit, pet }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-screen overflow-y-auto">
        <div className="p-6 border-b bg-gradient-to-r from-orange-500 to-blue-500">
          <h2 className="text-2xl font-bold text-white">Edit Pet</h2>
          <p className="text-orange-100 mt-1">Update the pet details below</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-lg font-medium transition-all duration-200 transform hover:scale-105"
            >
              Update Pet
            </button>
          </div>
